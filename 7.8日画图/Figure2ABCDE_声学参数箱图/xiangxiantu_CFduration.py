...
# 从Excel文件读取数据
df = pd.read_excel('1到10只CFduration.xlsx', engine='openpyxl')
# 获取不同分类的数量
...
plt.ylabel('CF duration (ms)', fontsize=38)
...
#保存图像
plt.savefig('1-10只CFduration.jpg', dpi=300, bbox_inches='tight')
#plt.savefig('1-10只CFduration.eps', dpi=300, bbox_inches='tight', format='eps')
'''
def rgb_to_hex(rgb):
