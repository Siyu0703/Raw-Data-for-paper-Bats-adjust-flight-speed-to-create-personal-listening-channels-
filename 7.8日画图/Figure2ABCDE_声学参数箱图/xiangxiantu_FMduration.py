...
# 从Excel文件读取数据
df = pd.read_excel('1到10只FMduration.xlsx', engine='openpyxl')
# 获取不同分类的数量
...
plt.ylabel('FM duration (ms)', fontsize=38)
...
#保存图像
plt.savefig('1-10只FMduration.jpg', dpi=300, bbox_inches='tight')
#plt.savefig('1-10只FMduration.eps', dpi=300, bbox_inches='tight', format='eps')
'''
def rgb_to_hex(rgb):
